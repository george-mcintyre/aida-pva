...
when it loads the Channel Provider image.  This is done with the SYMBOL_VECTOR in the corresponding transfer file.  

e.g. (excerpt from AIDASLCDB_XFR_ALPHA.OPT file)
```text
case_sensitive=YES
