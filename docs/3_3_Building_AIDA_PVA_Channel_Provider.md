...
```shell
 MCCDEV> CMP *.h
  Processing file DATA_DISK_SLC:[.AIDASLCDB]SLC_SERVER.H;11
...
%CMS-E-NOTFOUND, Element SLC_SERVER.H not found
 Please enter CMS CREATE ELEMENT remark. [AIDASLCDB Deployment]:
%CMS-S-CREATED, element CMS_:[C_INC]SLC_SERVER.H created
 %STRIP_C_COMMENTS-I, producing file REF_C_INC:SLC_SERVER.NO_COMMENTS_H
 MCCDEV>
```
...
MCCDEV> CINC *.C
 Processing file DATA_DISK_SLC:[SCRATCH.SLY.DEV.AIDA-PVA.PROVIDERS.SLC]SLC_SERVER.C;13
