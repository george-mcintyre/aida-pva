...
//
public abstract class DpSlcIPOA
               ...
               DpSlcIOperations
{
    ...
    _this()
    {
        return DpSlcIHelper.narrow(super._this_object());
    }

    public DpSlcI
    _this(org.omg.CORBA.ORB orb)
    {
        return DpSlcIHelper.narrow(super._this_object(orb));
    }
               ...
               org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        catch(edu.stanford.slac.aida.lib.util.except.UnableToGetDataException _ob_ex)
        {
            out = handler.createExceptionReply();
            edu.stanford.slac.aida.lib.util.except.UnableToGetDataExceptionHelper.write(out, _ob_ex);
        }
        return out;
    }
                ...
                org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        catch(edu.stanford.slac.aida.lib.util.except.ServerInitialisationException _ob_ex)
        {
            out = handler.createExceptionReply();
            edu.stanford.slac.aida.lib.util.except.ServerInitialisationExceptionHelper.write(out, _ob_ex);
        }
        return out;
    }
               ...
               org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        catch(edu.stanford.slac.aida.lib.util.except.UnableToSetDataException _ob_ex)
        {
            out = handler.createExceptionReply();
            edu.stanford.slac.aida.lib.util.except.UnableToSetDataExceptionHelper.write(out, _ob_ex);
        }
        return out;
    }
                        ...
                        org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        catch(edu.stanford.slac.aida.lib.util.except.MonitorStartupException _ob_ex)
        {
            out = handler.createExceptionReply();
            edu.stanford.slac.aida.lib.util.except.MonitorStartupExceptionHelper.write(out, _ob_ex);
        }
        return out;
    }
                       ...
                       org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        catch(edu.stanford.slac.aida.lib.util.except.MonitorShutdownException _ob_ex)
        {
            out = handler.createExceptionReply();
            edu.stanford.slac.aida.lib.util.except.MonitorShutdownExceptionHelper.write(out, _ob_ex);
        }
        return out;
    }
}
