...
//
final public class DpSlcUtilIHelper
{
    public static void
    insert(org.omg.CORBA.Any any, DpSlcUtilI val)
    {
        any.insert_Object(val, type());
    }

    public static DpSlcUtilI
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "DpSlcUtilI");
        }
    ...
    id()
    {
        return "IDL:dp.aida.slac.stanford.edu/dpSlcUtil/DpSlcUtilI:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _DpSlcUtilIStub _ob_stub = new _DpSlcUtilIStub();
        _ob_stub._set_delegate(_ob_impl._get_delegate());
        return _ob_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, DpSlcUtilI val)
    {
