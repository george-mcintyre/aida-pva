 ...
 * Class:     slac_aida_NativeChannelProvider
 * Method:    aidaSetValue
 * Signature: (Ljava/lang/String;Ledu/stanford/slac/aida/lib/model/AidaArguments;)V
 */
JNIEXPORT void JNICALL Java_slac_aida_NativeChannelProvider_aidaSetValue
		(JNIEnv *, jobject, jstring, jobject);
 ...
 * Signature: (Ljava/lang/String;Ledu/stanford/slac/aida/lib/model/AidaArguments;)Ledu/stanford/slac/aida/lib/model/AidaTable;
 */
JNIEXPORT jobject JNICALL Java_slac_aida_NativeChannelProvider_aidaSetValueWithResponse
		(JNIEnv *, jobject, jstring, jobject);
