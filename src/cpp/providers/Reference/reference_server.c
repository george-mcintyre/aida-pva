...
char* aidaRequestString(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	// allocate and return
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, item, strlen(data) + strlen(x) + 3, "string", NULL)
...
Array aidaRequestBooleanArray(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, booleanArray.items, sizeof(unsigned char), "boolean array", booleanArray)
...
Array aidaRequestByteArray(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	Array byteArray;
	byteArray.count = 1;
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, byteArray.items, sizeof(unsigned char), "byte array", byteArray)
...
Array aidaRequestShortArray(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	Array shortArray;
	shortArray.count = 1;
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, shortArray.items, sizeof(short), "short array", shortArray)
...
Array aidaRequestIntegerArray(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, integerArray.items, sizeof(int), "integer array", integerArray)
...
Array aidaRequestLongArray(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	Array longArray;
	longArray.count = 1;
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, longArray.items, sizeof(long), "long array", longArray)
...
Array aidaRequestFloatArray(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	Array floatArray;
	floatArray.count = 1;
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, floatArray.items, sizeof(float), "float array", floatArray)
...
Array aidaRequestDoubleArray(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	Array doubleArray;
	doubleArray.count = 1;
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, doubleArray.items, sizeof(double), "double array", doubleArray)
...
StringArray aidaRequestStringArray(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	stringArray.count = 1;
	ALLOCATE_MEMORY_AND_ON_ERROR_RETURN_(env, stringArray.items, sizeof(char*), "string array", stringArray);
	ALLOCATE_STRING_AND_ON_ERROR_RETURN_(env, stringArray.items[0], "eighteen", "string in string array", stringArray);
...
Table aidaRequestTable(JNIEnv* env, const char* uri, Arguments arguments)
{
	...
	ON_EXCEPTION_RETURN_(table)
	tableAddSingleRowShortColumn(env, &table, (short)(3 + xShort));
	ON_EXCEPTION_RETURN_(table)
