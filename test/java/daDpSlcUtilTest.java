 ...
 * the DpSlcUtil data provider.
 *
 * @author  15-Jun-2006 Bob Hall. Based on daDpSlcTest.java
 */
public class daDpSlcUtilTest
{
    ...
    {
        err = Err.getInstance("daDpSlcUtilTest");

        // Class defining tests of the DpSlcUtil Data Provider
        DpSlcUtilTests t = new DpSlcUtilTests(args);
